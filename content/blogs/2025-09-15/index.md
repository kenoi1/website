...
I had found some forum articles ([Qt forum](https://forum.qt.io/topic/115805/render-eglimagekhr-into-qopenglframebufferobject/2), [Arm developer forum](https://developer.arm.com/documentation/ka004859/latest/)) related to rendering OpenGL textures which used the [EGL library](https://registry.khronos.org/EGL/sdk/docs/man/) and were quite helpful. I also looked at the [SPICE GTK widget](https://www.spice-space.org/spice-gtk.html) source code which gave me some ideas on the GL parameters to work with. 
